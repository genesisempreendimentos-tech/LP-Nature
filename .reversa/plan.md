# Plano de Exploração — Nature - Pagina de Vendas

> Criado pelo Reversa em 2026-09-10
...
- [x] **Archaeologist** — Análise do módulo `app-shell` ✅
- [x] **Archaeologist** — Análise do módulo `hero` ✅
- [x] **Archaeologist** — Análise do módulo `marketing-sections` ✅
- [x] **Archaeologist** — Análise do módulo `location-map` ✅
- [x] **Archaeologist** — Análise do módulo `lead-capture` ✅
- [x] **Archaeologist** — Análise do módulo `motion` ✅
- [x] **Archaeologist** — Análise do módulo `content-data` ✅
