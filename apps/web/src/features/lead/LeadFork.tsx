...
function buildWhatsAppHref() {
  const phone = shellFooter.whatsapp.replace(/\D/g, "")
  const text = encodeURIComponent(shellFooter.whatsappMessage)
...
export default function LeadFork({
  ...
  const onWhatsApp = async () => {
    ...
    setError(null)
    try {
      await patchLead(leadId, { whatsapp_clicked: true })
