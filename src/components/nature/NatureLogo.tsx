interface NatureLogoProps {
  light?: boolean
  className?: string
  /** Hide wordmark (collapsed pill / mark-only) */
  markOnly?: boolean
}
  ...
  return (
    ...
    >
      ...
      <span className="nature-logo-type">
        <img className="nature-logo-base" src="/brand/nature-wordmark.svg" alt="" width="162" height="15" />
        <img className="nature-logo-color" src="/brand/nature-wordmark.svg" alt="" width="162" height="15" aria-hidden="true" />
      </span>
    </span>
  )
}
